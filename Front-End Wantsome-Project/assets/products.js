...
function renderSearch(products){
    searchBtn.addEventListener("click", function(e){
        ...
        products.forEach(element =>{
            ...
            searchResultBox.setAttribute("style", "width: 70%; padding: 1%; display:flex; justify-content: space-between; align-items: center; margin: 3% auto; border: 3px groove lightgrey")
            ...
            searchDetails.setAttribute("style", "width: 15%; padding: 2%; background: transparent; border: 2px solid lightgrey;")
        ...
        if(t === 0){
            ...
            var searchResultError = document.createElement("p");
             ...
             searchResultError.style.margin = "5% 15% 5% 15%";
